...
bool check_for_card(const char* RENDERER, const char* bad_card)
{
    if (!strnicmp(RENDERER, bad_card, strlen(bad_card)))
    {
        std::string buffer = llformat(
            "Your video card appears to be a %s, which qikfox3D does not support.\n"
            "\n"
            "qikfox3D requires a video card with 32 Mb of memory or more, as well as\n"
            ...
            "Phoenix Viewer Support group in world, or visit www.qikfox3Dviewer.org\n"
            "for support.\n"
            "\n"
            "You can try to run qikfox3D, but it will probably crash or run\n"
